...
<head>
    ...
    <title>Welcome to CAC Bank</title>
</head>
<body>
  ...
  <?php require_once './include/header.php' ?>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/ICB_BANK.jpeg" class="d-block w-100 img-fluid"  alt="...">
            <div class="carousel-caption d-none d-md-block external-img">
              <h5>CAC Bank</h5>
              <p>Safe Position for your Currency.</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="img/bancos-comerciais-1-1.jpeg" class="d-block w-100 img-fluid" alt="...">
            <div class="carousel-caption d-none d-md-block external-img">
              <h5>Transmit Money exceptionally</h5>
      ...
      <!-- CArosoul part end -->
        ...
        <div class="container my-5">
            ...
            <div class="row row-cols-2">       
              ...
              <div class="col">
              <img src="img/premium.jpeg" class="rounded img-fluid float-right" alt="...">
              </div>
            </div>
            </section>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6 " >
            <img class="rounded img-fluid float-left" src="img/photo.jpeg" />
          </div>
